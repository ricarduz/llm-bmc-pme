...
Desenvolvimento local — não requer build nem dependências; basta abrir `index.html` num navegador, ou servir a pasta com qualquer servidor estático.
...
Os blocos marcados como *"conteúdo a integrar"* na Matriz (Instrumento 2) e em três das Fichas de Decisão (Instrumento 3) aguardam confirmação do texto exato contra o Apêndice de Instrumentos da dissertação, para preservar a regra de não incluir conteúdo não verificado.
