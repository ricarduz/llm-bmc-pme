...
const TRADUCOES = {
  pt: {
    ...
    'entrevista-fazer-texto-1': 'Sou eu, Ricardo, quem lhe propõe esta entrevista semiestruturada, no âmbito da validação do framework desenvolvido na minha dissertação de Mestrado em Engenharia Informática e Tecnologia Web. A sessão tem a duração aproximada de 60 minutos, estruturada em três momentos: uma apresentação do artefacto (~15 min), em que percorremos juntos os três instrumentos do framework — o Diagnóstico de Pré-requisitos, a Matriz LLM × BMC e as Fichas de Decisão — sem aplicação a um caso concreto; uma entrevista semiestruturada (~35 min), organizada pelos quatro critérios de avaliação, pela ordem utilidade percebida, aplicabilidade, consistência com a literatura e completude; e um momento de reflexão livre (~10 min), para observações não cobertas pelo guião.',
    'entrevista-fazer-texto-2': 'Não há respostas certas ou erradas — o que procuro é a sua apreciação fundamentada na sua experiência profissional. Pode interromper a qualquer momento para colocar questões.',
    ...
    'pme-relatorio-lead': 'As áreas a azul são onde identificámos o maior potencial imediato para adotar Large Language Models no seu negócio.',
  ...
  en: {
    ...
    'entrevista-fazer-texto-1': 'I\'m Ricardo, and I\'m the one proposing this semi-structured interview, as part of validating the framework developed in my Master\'s dissertation in Computer Engineering and Web Technology. The session lasts approximately 60 minutes, structured in three moments: a presentation of the artefact (~15 min), where we go through the framework\'s three instruments together — the Prerequisites Diagnostic, the LLM × BMC Matrix, and the Decision Sheets — without applying them to a specific case; a semi-structured interview (~35 min), organised around the four evaluation criteria, in the order perceived usefulness, applicability, consistency with the literature, and completeness; and a free reflection moment (~10 min), for observations not covered by the script.',
    'entrevista-fazer-texto-2': 'There are no right or wrong answers — what I\'m looking for is your informed assessment based on your professional experience. You can interrupt at any time to ask questions.',
    ...
    'pme-relatorio-lead': 'The areas in blue are where we identified the greatest immediate potential for adopting Large Language Models in your business.',
