...
const TRADUCOES = {
  pt: {
    ...
    'pme-consentimento': 'Li e compreendi a informação acima e aceito participar neste estudo, autorizando o envio dos dados do diagnóstico, sem qualquer identificação pessoal ou da empresa, para a base de dados desta investigação académica.',
    'pme-nota-navegador': 'As suas respostas ficam guardadas neste navegador enquanto usa a ferramenta e são apagadas no fim da sessão.',
    ...
    'i2-nota-cobertura': 'Nem todos os blocos têm Ficha de Decisão disponível — o âmbito de 4 blocos (Canais, Relacionamento com Clientes, Atividades-Chave, Recursos-Chave) reflete a densidade de evidência empírica encontrada na revisão de literatura, não uma limitação do diagnóstico.',
    ...
    'entrevista-autorizacao': 'Li e compreendi a informação acima e autorizo a minha participação nesta sessão de avaliação, bem como a utilização das minhas respostas, de forma anonimizada, no âmbito desta dissertação de Mestrado.',
    // Autorização de gravação autónoma e facultativa: o ponto 4 dos
    // procedimentos da Comissão de Ética exige aceitação explícita do
    // registo de som, que uma autorização genérica de participação não cobre.
    'entrevista-autorizacao-audio': 'Autorizo que a sessão seja objeto de gravação áudio, exclusivamente para transcrição pelo investigador, com eliminação do ficheiro após a validação da transcrição. (Facultativo — pode participar sem autorizar a gravação.)',
    'entrevista-antes-titulo': 'Antes de dar o seu consentimento',
    'entrevista-antes-quem': '<strong>Quem faz este estudo:</strong> Ricardo Serafim, estudante de Mestrado em Engenharia Informática e Tecnologia Web (Universidade Aberta / UTAD). Contacto: <a href="mailto:2302605@estudante.uab.pt">2302605@estudante.uab.pt</a>.',
    // A data abaixo fecha a janela de desistência e tem de ser anterior à
    // agregação e anonimização dos contributos. Confirmar antes de publicar.
    'entrevista-antes-voluntaria': '<strong>Participação voluntária:</strong> pode interromper a sessão ou desistir a qualquer momento, sem justificação e sem qualquer consequência. Pode ainda solicitar a eliminação da gravação e da transcrição até 30 de novembro de 2026, data a partir da qual os contributos são agregados e anonimizados para análise.',
    'entrevista-antes-dados': '<strong>Confidencialidade:</strong> a sua identidade é conhecida apenas pelo investigador. Na dissertação e em qualquer publicação, é identificado exclusivamente por um código de perfil, sem menção de nome, organização ou cargo, e os excertos citados são previamente anonimizados. A gravação é eliminada logo após a validação da transcrição; as transcrições, seis meses após as provas públicas.',
    'entrevista-antes-riscos': '<strong>Riscos:</strong> reduzidos. Além do tempo despendido, existe um risco residual de um leitor com conhecimento do contexto associar um excerto a si — mitigado pela codificação dos participantes e pela supressão de referências a organizações, projetos ou clientes. As questões incidem sobre o artefacto, não sobre si ou sobre a sua organização.',
    'entrevista-antes-divulgacao': '<strong>Resultados:</strong> apresentados na dissertação, depositada em acesso aberto no Repositório Aberto da Universidade Aberta, e em eventuais publicações científicas. Ser-lhe-á remetida a síntese das conclusões e, se o solicitar, a transcrição da sua sessão.',
    'entrevista-antes-link': 'Ler a informação completa ao participante (PDF) →',
    'entrevista-continuar': 'Continuar →',
    'materiais-titulo-pagina': 'Materiais dos instrumentos · LLM em PME',
    'materiais-eyebrow': 'Antes de começar',
    'materiais-h1': 'Materiais de apoio a cada instrumento',
    'materiais-lead': 'Um resumo de cada instrumento, com o respetivo documento em PDF — para consulta enquanto percorre a versão interativa, ou para ler antecipadamente.',
    'materiais-aba-1': 'Instrumento 1',
    'materiais-aba-2': 'Instrumento 2',
    'materiais-aba-3': 'Instrumento 3',
    'materiais-abrir-pdf': 'Abrir PDF do Instrumento 1 →',
    'materiais-abrir-pdf-2': 'Abrir PDF do Instrumento 2 →',
    'materiais-abrir-pdf-3': 'Abrir PDF do Instrumento 3 →',
    'materiais-continuar': 'Continuar →',
    'sessao-titulo-pagina': 'Documentos da sessão · LLM em PME',
    'sessao-eyebrow': 'Antes de começar',
    'sessao-h1': 'Documentos da sessão',
    'sessao-lead': 'Dois documentos de apoio à entrevista — consulte-os antes de avançar para os instrumentos.',
    'sessao-nota-titulo': 'Nota de Sessão',
    'sessao-nota-desc': 'Objetivo da sessão, estrutura dos 60 minutos, o que vai fazer na ferramenta, consentimento e proteção de dados. Comum aos três perfis do painel.',
    'sessao-nota-abrir': 'Abrir Nota de Sessão →',
    'sessao-sintese-titulo': 'Síntese Teórica',
    'sessao-sintese-desc': 'Fundamentação teórica do framework — o problema, o Business Model Canvas, a distinção entre camada analítica e camada de implantação, e a correspondência entre a Matriz LLM × BMC e a revisão de literatura, por área. Enviada só ao especialista de perfil académico, para apoiar a avaliação do critério consistência com a literatura.',
    'sessao-sintese-abrir': 'Abrir Síntese Teórica →',
    'sessao-continuar': 'Continuar →',
    ...
    // Bloco "Antes de começar": cobre os itens exigidos pela checklist de
    // análise de questionários da Comissão de Ética da UAb (responsável,
    // instituição, objetivos, tipo de perguntas, tempo, voluntariedade,
    // anonimato, confidencialidade, conservação, riscos, divulgação e
    // contacto). Alterar com cuidado — cada parágrafo responde a um item.
    'pme-antes-titulo': 'Antes de começar',
    'pme-antes-quem': '<strong>Quem faz este estudo:</strong> Ricardo Serafim, estudante de Mestrado em Engenharia Informática e Tecnologia Web (Universidade Aberta / UTAD). Contacto: <a href="mailto:2302605@estudante.uab.pt">2302605@estudante.uab.pt</a>.',
    'pme-antes-porque': '<strong>Para quê:</strong> investigar como as pequenas e médias empresas europeias podem adotar Large Language Models de forma estruturada, e avaliar se este instrumento é útil para apoiar essa decisão.',
    'pme-antes-perguntas': '<strong>O que vai responder:</strong> quatro perguntas sobre a empresa (setor, número de colaboradores, escalão de faturação e região) e dezoito perguntas fechadas sobre processos internos, canais, relação com clientes e recursos tecnológicos. Cerca de 10 minutos.',
    'pme-antes-voluntaria': '<strong>Participação voluntária:</strong> pode interromper a qualquer momento, sem justificação e sem qualquer consequência. Como o questionário é anónimo, depois de submetidas as respostas não é possível localizá-las nem apagá-las individualmente.',
    'pme-antes-dados': '<strong>Anonimato e confidencialidade:</strong> não são recolhidos nome, cargo, contacto, designação da empresa nem localização exata. Os dados são usados exclusivamente neste estudo, tratados de forma agregada, armazenados em ambiente Google Workspace com acesso restrito ao investigador, e eliminados seis meses após as provas públicas da dissertação.',
    'pme-antes-riscos': '<strong>Riscos:</strong> mínimos. O principal ónus é o tempo despendido. O relatório final tem natureza informativa e não substitui aconselhamento técnico ou jurídico especializado.',
    'pme-antes-divulgacao': '<strong>Resultados:</strong> divulgados apenas de forma agregada, na dissertação — depositada em acesso aberto no Repositório Aberto da Universidade Aberta — e em eventuais publicações científicas dela decorrentes.',
    'pme-antes-link': 'Ler a informação completa ao participante (PDF) →',
    'pme-comecar': 'Começar →',
    ...
    'pme-relatorio-lead': 'As áreas assinaladas como "Prioritário" são onde identificámos o maior potencial imediato para adotar Large Language Models (LLM) — a tecnologia por trás de assistentes como o ChatGPT — no seu negócio.',
    ...
    'pme-porque-sentido': 'Porque é que faz sentido',
  ...
  en: {
    ...
    'pme-consentimento': 'I have read and understood the information above and I agree to take part in this study, authorising the diagnostic data, with no identification of me or of the company, to be sent to the database of this academic research.',
    'pme-nota-navegador': 'Your answers are saved in this browser while you use the tool and are deleted at the end of the session.',
    ...
    'i2-nota-cobertura': 'Not every block has a Decision Sheet available — the 4-block scope (Channels, Customer Relationships, Key Activities, Key Resources) reflects the density of empirical evidence found in the literature review, not a limitation of the diagnostic.',
    ...
    'entrevista-autorizacao': 'I have read and understood the information above and I authorise my participation in this evaluation session, as well as the use of my responses, in anonymised form, as part of this dissertation.',
    'entrevista-autorizacao-audio': 'I authorise the session to be audio-recorded, exclusively for transcription by the researcher, with the file deleted once the transcript has been validated. (Optional — you may take part without authorising the recording.)',
    'entrevista-antes-titulo': 'Before giving your consent',
    'entrevista-antes-quem': '<strong>Who is running this study:</strong> Ricardo Serafim, MSc student in Computer Engineering and Web Technology (Universidade Aberta / UTAD). Contact: <a href="mailto:2302605@estudante.uab.pt">2302605@estudante.uab.pt</a>.',
    'entrevista-antes-voluntaria': '<strong>Voluntary participation:</strong> you may interrupt the session or withdraw at any time, without justification and without any consequence. You may also request deletion of the recording and transcript until 30 November 2026, after which contributions are aggregated and anonymised for analysis.',
    'entrevista-antes-dados': '<strong>Confidentiality:</strong> your identity is known only to the researcher. In the dissertation and in any publication you are identified solely by a profile code, with no mention of name, organisation or role, and any quoted excerpts are anonymised beforehand. The recording is deleted as soon as the transcript is validated; transcripts, six months after the public defence.',
    'entrevista-antes-riscos': '<strong>Risks:</strong> low. Beyond the time spent, there is a residual risk that a reader familiar with the context might associate an excerpt with you — mitigated by coding participants and by removing references to organisations, projects or clients. The questions concern the artefact, not you or your organisation.',
    'entrevista-antes-divulgacao': '<strong>Results:</strong> presented in the dissertation, deposited in open access in the Universidade Aberta open repository, and in any scientific publications. You will receive a summary of the conclusions and, on request, the transcript of your own session.',
    'entrevista-antes-link': 'Read the full participant information (PDF) →',
    'entrevista-continuar': 'Continue →',
    'materiais-titulo-pagina': 'Instrument materials · LLM in SMEs',
    'materiais-eyebrow': 'Before you begin',
    'materiais-h1': 'Supporting materials for each instrument',
    'materiais-lead': 'A summary of each instrument, with the corresponding PDF document — for reference while going through the interactive version, or to read in advance.',
    'materiais-aba-1': 'Instrument 1',
    'materiais-aba-2': 'Instrument 2',
    'materiais-aba-3': 'Instrument 3',
    'materiais-abrir-pdf': 'Open Instrument 1 PDF →',
    'materiais-abrir-pdf-2': 'Open Instrument 2 PDF →',
    'materiais-abrir-pdf-3': 'Open Instrument 3 PDF →',
    'materiais-continuar': 'Continue →',
    'sessao-titulo-pagina': 'Session documents · LLM in SMEs',
    'sessao-eyebrow': 'Before you begin',
    'sessao-h1': 'Session documents',
    'sessao-lead': 'Two supporting documents for the interview — please review them before moving on to the instruments.',
    'sessao-nota-titulo': 'Session Note',
    'sessao-nota-desc': 'Purpose of the session, the structure of the 60 minutes, what you will do in the tool, consent and data protection. Common to all three panel profiles.',
    'sessao-nota-abrir': 'Open Session Note →',
    'sessao-sintese-titulo': 'Theoretical Synthesis',
    'sessao-sintese-desc': 'Theoretical grounding of the framework — the problem, the Business Model Canvas, the distinction between the analytical layer and the deployment layer, and the correspondence between the LLM × BMC Matrix and the literature review, by area. Sent only to the academic-profile specialist, to support the evaluation of the consistency-with-literature criterion.',
    'sessao-sintese-abrir': 'Open Theoretical Synthesis →',
    'sessao-continuar': 'Continue →',
    ...
    'pme-antes-titulo': 'Before you start',
    'pme-antes-quem': '<strong>Who is running this study:</strong> Ricardo Serafim, MSc student in Computer Engineering and Web Technology (Universidade Aberta / UTAD). Contact: <a href="mailto:2302605@estudante.uab.pt">2302605@estudante.uab.pt</a>.',
    'pme-antes-porque': '<strong>Purpose:</strong> to investigate how European small and medium-sized enterprises can adopt Large Language Models in a structured way, and to assess whether this instrument is useful in supporting that decision.',
    'pme-antes-perguntas': '<strong>What you will answer:</strong> four questions about the company (sector, headcount, turnover bracket and region) and eighteen closed questions about internal processes, channels, customer relationships and technological resources. Around 10 minutes.',
    'pme-antes-voluntaria': '<strong>Voluntary participation:</strong> you may stop at any time, without justification and without any consequence. As the questionnaire is anonymous, once answers are submitted they cannot be located or deleted individually.',
    'pme-antes-dados': '<strong>Anonymity and confidentiality:</strong> no name, role, contact details, company name or exact location are collected. The data are used exclusively in this study, processed in aggregate, stored in a Google Workspace environment with access restricted to the researcher, and deleted six months after the public defence of the dissertation.',
    'pme-antes-riscos': '<strong>Risks:</strong> minimal. The main burden is the time spent. The final report is informative in nature and does not replace specialised technical or legal advice.',
    'pme-antes-divulgacao': '<strong>Results:</strong> disclosed in aggregate form only, in the dissertation — deposited in open access in the Universidade Aberta open repository — and in any scientific publications arising from it.',
    'pme-antes-link': 'Read the full participant information (PDF) →',
    'pme-comecar': 'Start →',
    ...
    'pme-relatorio-lead': 'The areas marked "Priority" are where we identified the greatest immediate potential for adopting Large Language Models (LLMs) — the technology behind assistants like ChatGPT — in your business.',
...
const TRADUCOES_I1_EN = {
  ...
  perguntasJogo: [
    ...
    { bloco: 'proposta-valor', eixo: 'prontidao', pergunta: 'Do you tend to adapt what you offer to each customer — whether the product, the service, or commercial content?', opcoes: ['Rarely', 'Sometimes', 'Yes, frequently'] },
